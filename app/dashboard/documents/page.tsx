        ...
        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginBottom: '20px' }}>
          {Object.entries(CATEGORIES).map(([k, v]) => (
            <button
              ...
              style={{ padding: '5px 12px', borderRadius: '20px', border: `1px solid ${activeCategory === k ? v.color : '#e8e6e2'}`, background: activeCategory === k ? '#f0f4f8' : '#fff', color: activeCategory === k ? v.color : '#827d76', fontSize: '11px', fontWeight: '500', cursor: 'pointer' }}
            >
              {v.label}
